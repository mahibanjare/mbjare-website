...
export const packages: GrowthPackage[] = [
  {
    ...
    proof: {
      ...
      note: 'Complete digital presence built from zero',
    },
  ...
  },
  {
    ...
    proof: {
      client: 'Hotel Kunwar Shree',
      url: 'https://www.hotelkunwarshree.com',
      image: '/projects/hotelkunwarshree.png',
      note: 'Hotel website, QR menu & guest system — Arang',
    },
